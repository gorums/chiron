...
async function useBridge() {
  ...
  const l0 = log();
  if (l0)
    l0.innerHTML = `<div class="hint"><span class="i">…</span>Looking for the bridge, then for Claude Code.</div>`;
        ...
        : `<div class="hint warn"><span class="i">!</span>
         <div><b>The bridge is running, but Claude Code did not answer.</b> ${
           j.cli
             ...
             : "It does not appear to be installed. Install Claude Code and sign in, or use an API key instead."
         }</div></div>`;
