...
common/skills/course-author/    the skill that writes a course from a brief. Each tool
                            scans a folder of its own, so .claude/skills/,
                            .codex/skills/ and .gemini/commands/ hold stubs that
                            point at it (common/skills/README.md)
```
...
- `common/skills/course-author/references/module-format.md` — the markdown contract
- `common/skills/course-author/references/data-schemas.md` — the JSON schemas
- `common/skills/course-author/references/pedagogy.md` — what makes a course worth finishing
